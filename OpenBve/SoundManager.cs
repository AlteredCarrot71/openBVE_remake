...
namespace OpenBve
{
    internal static class SoundManager
    {
        ...
        internal static void PlaySound(ref int SoundSourceIndex, int SoundBufferIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped)
        {
            PlaySound(ref SoundSourceIndex, true, SoundBufferIndex, null, -1, Position, Important, Looped, 1.0, 1.0);
        }
        internal static void PlaySound(int SoundBufferIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped)
        {
            int a = -1;
            PlaySound(ref a, false, SoundBufferIndex, null, -1, Position, Important, Looped, 1.0, 1.0);
        }
        internal static void PlaySound(int SoundBufferIndex, TrainManager.Train Train, int CarIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped)
        {
            int a = -1;
            PlaySound(ref a, false, SoundBufferIndex, Train, CarIndex, Position, Important, Looped, 1.0, 1.0);
        }
        internal static void PlaySound(ref int SoundSourceIndex, int SoundBufferIndex, TrainManager.Train Train, int CarIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped)
        {
            PlaySound(ref SoundSourceIndex, true, SoundBufferIndex, Train, CarIndex, Position, Important, Looped, 1.0, 1.0);
        }
        internal static void PlaySound(int SoundBufferIndex, TrainManager.Train Train, int CarIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped, double Pitch, double Gain)
        {
            int a = -1;
            PlaySound(ref a, false, SoundBufferIndex, Train, CarIndex, Position, Important, Looped, Pitch, Gain);
        }
        internal static void PlaySound(ref int SoundSourceIndex, int SoundBufferIndex, TrainManager.Train Train, int CarIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped, double Pitch, double Gain)
        {
            PlaySound(ref SoundSourceIndex, true, SoundBufferIndex, Train, CarIndex, Position, Important, Looped, Pitch, Gain);
        }
        private static void PlaySound(ref int SoundSourceIndex, bool ReturnHandle, int SoundBufferIndex, TrainManager.Train Train, int CarIndex, Worlds.Vector.Vector3D Position, Importance Important, bool Looped, double Pitch, double Gain)
        {
            if (OpenAlContext != IntPtr.Zero)
            {
